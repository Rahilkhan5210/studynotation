     ...
     setFormData(prevData =>{
      ...
      return (
        <div>
            ...
            <div
            className='flex bg-slate-950 p-1 gap-x-1 my-6 rounded-full max-w-max'>
                ...
                <div className='flex gap-x-4 mt-[20px]'>
                        <label className='w-full'>
                            ...
                            <input
                                ...
                                className='bg-slate-950 rounded-[0.5rem] text-slate-50 w-full p-[12px]'
                            />
                        </label>
            ...
            <button className=' w-full bg-yellow-300 rounded-[8px] font-medium text-slate-950 px-[12px] py-[8px] mt-6'>
                Create Account
            </button>
            </form>
